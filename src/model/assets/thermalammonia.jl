...
fuel_edge::Edge{T}, n2_edge::Edge{<:Nitrogen}, co2_edge::Edge{<:CO2}) where T<:Commodity =
    ThermalAmmonia{T}(id, thermalammonia_transform, nh3_edge, elec_edge, fuel_edge, n2_edge, co2_edge)
...
function full_default_data(::Type{ThermalAmmonia}, id=missing)
    return OrderedDict{Symbol,Any}(
        ...
        :transforms => @transform_data(
            ...
            :emission_rate => 0.181048235160161,            # 0.181048235160161 tons CO2 per MWh of CH4
...
function make(asset_type::Type{ThermalAmmonia}, data::AbstractDict{Symbol,Any}, system::System)
    ...
    n2_end_node = thermalammonia_transform
    n2_edge = Edge(
    ...
    return ThermalAmmonia(id, thermalammonia_transform, nh3_edge, elec_edge, fuel_edge, n2_edge, co2_edge)
end 